...
int main(int argc,char** argv)
{
    ...
    TFitResultPtr fit_bkg = histoMassBkg->Fit("expo","SRQ","",50,800);
    TFitResultPtr fit_signal = histoMassSignal->Fit("gaus","SRQ","",1500,3000);
    TFitResultPtr fit_signal_before = histoMassSignalBefore->Fit("gaus","SRQ","",1000,2000);
...
cout<<ecart_signal_before_bin<<endl;
    ...
    TFitResultPtr fit_bkg_before = histoMassBkgBefore->Fit("expo","SRQ","",50,400);
